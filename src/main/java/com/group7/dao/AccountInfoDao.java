...
public interface AccountInfoDao {
     ...
     * @return
     */
    int addIdCardNum(@Param("realName") String realName, @Param("sex") String sex, @Param("idNum") String idNum, @Param("address") String address,@Param("education") String education,@Param("marriage") String marriage,@Param("basicIncome") String basicIncome,@Param("birthday") String birthday,@Param("userinformationid") int userinformationid);
     ...
     * @return
     */
    int changePayPwd(@Param("newPayPwd")String newPayPwd,@Param("userinformationid") int userinformationid);
